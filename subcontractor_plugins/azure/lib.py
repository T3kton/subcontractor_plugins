...
def _connect( connection_paramaters ):
  ...
  credentials = ServicePrincipalCredentials( client_id=connection_paramaters[ 'client_id' ], secret=connection_paramaters[ 'password' ], tenant=connection_paramaters[ 'tenant_id' ] )
